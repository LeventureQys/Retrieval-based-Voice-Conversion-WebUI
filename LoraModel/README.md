...
> **项目状态**: 开发中 | **最后更新**: 2026-01-28

---

## 🚀 快速开始

**新用户？** 查看 [快速入门指南 (QUICKSTART.md)](QUICKSTART.md) 5 分钟快速上手！
...
| 端到端测试 | 🔄 进行中 | 需修复 PyTorch 2.6 兼容性问题 |

**待解决问题**: PyTorch 2.6 更改了 `torch.load` 默认行为，需要修复 HuBERT 模型加载。详见 [TODO.md](TODO.md)。
